...
export const blockRegex = /(^|\n)(:::(?:quiz|keypoint|choice|multiple_choice|fill_in|true_false|step_solver|comparison|correction|checklist|tips|suggestions|plot|chart|complex_plane|planar_geometry|solid_geometry|exam_config|essay_generator|essay_decisions)\s*?\n[\s\S]*?\n:::)(?=\n|$)/g;
